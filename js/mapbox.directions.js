...
module.exports = function (container, directions) {
    ...
    directions.on('selectRoute', function (e) {
        ...
        steps.append('div')
            ...
            .html(function (step) { return translate(step.maneuver.instruction); });
...
function translate(text) {
	var text = text.replace("Head", "Ir al");
	
	var text = text.replace("northwest", "noroeste");
	var text = text.replace("southeast", "sudeste");
	var text = text.replace("northeast", "nordeste");
	var text = text.replace("southwest", "suroeste");
	
	var text = text.replace("west", "oeste");
	var text = text.replace("east", "este");
	var text = text.replace("south", "sur");
	var text = text.replace("north", "norte");
	
	var text = text.replace("Make a sharp right onto", "Gire totalmente a la derecha en");
	var text = text.replace("Make a sharp left onto", "Gire totalmente a la izquierda en");
	
	var text = text.replace("Make a sharp right", "Gire totalmente a la derecha");
	var text = text.replace("Make a sharp left", "Gire totalmente a la derecha");
	
	var text = text.replace("Turn left onto", "Gire a la izquierda en");
	var text = text.replace("Bear right onto", "Gire a la derecha en");
	var text = text.replace("Turn right onto", "Gire a la derecha en");
	...
	var text = text.replace("Continue", "Continuar");
	
	var text = text.replace("You have arrived at your destination", "Usted ha llegado a su destino");
	
	var text = text.replace(" on ", " en ");
